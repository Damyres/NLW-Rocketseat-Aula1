...
public class ExceptionEntityHandler {
    ...
    public ResponseEntity handleEventNotFound(EventNoFoundException exception){
    ...
    public ResponseEntity handleCheckInAlreadExist(CheckInAlreadyExistsException exception){
        return ResponseEntity.status(HttpStatus.CONFLICT).build();
    }
}
